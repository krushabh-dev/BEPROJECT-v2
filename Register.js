          ...
          <View style={styles.loginarea}>
            <View style={styles.loginForm, styles.defaulTForm}>
              <View style={styles.formInner}>
                <Text style={styles.h3}>Create Account SuperApp</Text>
                <View>
                    ...
                    <View style={styles.fieldOuter}>
                      <View style={styles.TextinputGroup, styles.checkboxes, styles.square}>
                        ...
                        <Text htmlFor="remember" style={styles.remember}>
                          <span style={styles.customCheckbox}></span> Remember me
                        </Text>
                      </View>
                ...
                <View style={styles.bottomBox}>
                  <View style={{display: "flex"}}>
                    ...
                    <Pressable style={styles.text} onPress={() => navigation.navigate('Login')}>
                      Login
                    </Pressable>
                  </View>
